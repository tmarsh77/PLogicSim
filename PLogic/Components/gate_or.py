...
class GateOr(SpriteRenderer, LogicGate, Serializable):
    def __init__(self, simulator):
        LogicGate.__init__(self)
        image = simulator.resources.load_image("or.png")
    ...
    def resolve(self):
        self.q.set_signal(self, 1 if (self.i1.signal == 1 or self.i2.signal == 1) else 0)
